            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              >
                ...
                >
                  ...
                  <div className="w-10 h-10 mb-3 flex items-center justify-center bg-white/90 rounded-lg">
                    <img src="/images/ahrefs.png" alt="Ahrefs" className="w-7 h-7" />
                  </div>
                  <div className="text-amber-300 font-medium mb-2 hover:text-amber-200 text-base">Ahrefs</div>
                  <div className="text-xs text-gray-400 hover:text-gray-300">Analyze Ahrefs alternatives</div>
              ...
              >
                ...
                >
                  ...
                  <img src="/images/semrush.png" alt="Semrush" className="w-10 h-10 mb-3 rounded-lg" />
                  <div className="text-amber-400 font-medium mb-2 group-hover:text-amber-300 text-base">Semrush</div>
                  <div className="text-xs text-gray-400 group-hover:text-gray-300">Explore Semrush alternatives</div>
                  <div className="absolute bottom-3 right-3">
